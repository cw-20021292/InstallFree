    ...
    if(F_WaterOut == SET)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if( gu8Cup_level == CUP_LEVEL_HALF || gu8Cup_level == CUP_LEVEL_ONE )
                {
                    mu16_effluent_time = u16Efluent_Time + gu8_Effluent_Add_Time_Half;
                }
                else
    ...
    else
    {
        if( gu8_before_water_level == SET )
        {
            ...
            else
            {
                if( gu32_calc_one_day_user_none >= 2000 )
                {
                    gu8_Effluent_Add_Time_Half = WATER_EXTRACT_CMST_TIME_HALF_ONE;
                    gu8_Effluent_Add_Time_Two = WATER_EXTRACT_CMST_TIME_TWO_1LITGER;
