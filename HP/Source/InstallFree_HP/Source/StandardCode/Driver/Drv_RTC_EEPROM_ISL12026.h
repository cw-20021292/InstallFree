...
#define RTC_USE                                         USE      // RTC() 사용 여부 설정 - 0(No Use), 1(Use)
...
// G13
#define IICA0_MASTER_SEND_FUCTION                       R_IICA0_Master_Send      // Code Generate된 IICA0 Master Send 함수 배치
#define IICA0_MASTER_RECEIVE_FUCTION                    R_IICA0_Master_Receive   // Code Generate된 IICA0 Master Receive 함수 배치
